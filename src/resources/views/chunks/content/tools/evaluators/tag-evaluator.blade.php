...
<div class="row">
    <div class="{{ $raw === null ? 'col-12' : 'col-md-7' }}">
        ...
        <form method="POST">
            ...
            <div class="row mb-3">
                <div class="col-6">
                    <label for="evaluatedContent">
                        <h4>{{ $label }}</h4>
                        <p>{{ $description }}</p>
                    </label>
                </div>
                <div class="col-6">
                    <label for="tagListType" class="h4">Type</label>
                    <p>Select the type of values contained within the tag list.</p>
                    <select name="tagListType" id="tagListType" class="form-control">
                        @foreach ($tagTypes as $name => $value)
                            @if ($value == Request::input('tagListType'))
            ...
            <div class="card bg-light text-dark">
                <div class="card-body">
                    <textarea name="evaluatedContent[]" id="evaluatedContent" class="form-control text-monospace" cols="30" rows="10">{{ $raw }}</textarea>
